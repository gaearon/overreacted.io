...
If you're the first one to translate a post to your language, you'll need to add it to to the list in `./i18n.js`. See [this PR](https://github.com/pavoltravnik/opthamed.sk/pull/159) for an example. If your language needs special font characters, add it to the appropriate place in [this list](https://github.com/pavoltravnik/opthamed.sk/blob/5de6c128f798506a54a1a34c32cd5446beecc272/src/utils/i18n.js#L15).
