...
虽然我们没有 “Hook“ 版本的 `memo()` 或者 `shouldComponentUpdate()`，但 React 提供了一个 Hook 叫做 [`useMemo()`](https://reactjs.org/docs/hooks-reference.html#usememo)。它有类似的用途，但它的语义不同，因而并不会遇到上面所涉及到的问题。
