...
* **Нативная разработка.** Я как-то пытался выучить Objective C, но забил. До Swift не добрался. С джавой не сложилось. (Хотя после C# наверное я бы в ней разобрался.)
